...
"nodes.capacity": "Ёмкость",
  ...
  "nodes.agentUpdateImage": "Образ",
  "nodes.agentUpdateNodeSaid": "Ответ ноды",
  "nodes.agentUpdateOutput": "Вывод",
  ...
  // Facets. The panel's own background work outnumbers people on a quiet day,
  // so "кто" comes first; "о чём" folds the two spellings of a target type.
  "audit.deletedUser": "удалён",
  "audit.scopeLabel": "Кто",
  "audit.scope.all": "Все",
  "audit.scope.people": "Люди",
  "audit.scope.system": "Система",
  "audit.categoryLabel": "О чём",
  "audit.cat.all": "Всё",
  "audit.cat.keys": "Ключи",
  "audit.cat.users": "Пользователи",
  "audit.cat.nodes": "Серверы",
  "audit.cat.policy": "Политика",
  "audit.cat.rules": "Правила",
  "audit.cat.access": "Доступ",
  "audit.cat.checks": "Проверки",
  "audit.cat.quota": "Квоты",
  "audit.cat.other": "Прочее",
  "audit.clearFilters": "Сбросить фильтры · показано {count}",
...
"nodes.capacity": "Capacity",
  ...
  "nodes.agentUpdateImage": "Image",
  "nodes.agentUpdateNodeSaid": "The node said",
  "nodes.agentUpdateOutput": "Output",
  ...
  "audit.system": "System",
  "audit.deletedUser": "deleted",
  "audit.scopeLabel": "Who",
  "audit.scope.all": "All",
  "audit.scope.people": "People",
  "audit.scope.system": "System",
  "audit.categoryLabel": "About",
  "audit.cat.all": "All",
  "audit.cat.keys": "Keys",
  "audit.cat.users": "Users",
  "audit.cat.nodes": "Servers",
  "audit.cat.policy": "Policy",
  "audit.cat.rules": "Rules",
  "audit.cat.access": "Access",
  "audit.cat.checks": "Checks",
  "audit.cat.quota": "Quotas",
  "audit.cat.other": "Other",
  "audit.clearFilters": "Clear filters · {count} shown",
