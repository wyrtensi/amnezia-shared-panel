...
Then follow [CHECKLIST.md](CHECKLIST.md). `preflight.sh` is non-deploying: it checks Linux/amd64, Docker, TUN, immutable image references, strict permissions, fixed Compose configuration, port conflicts, 3 GiB free disk, and 350 MiB available RAM.
