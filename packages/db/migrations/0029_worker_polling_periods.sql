...
ALTER TABLE "portal_policy" ADD CONSTRAINT "portal_policy_maintenance_interval_range" CHECK ("portal_policy"."maintenance_interval_sec" IS NULL OR ("portal_policy"."maintenance_interval_sec" >= 3600 AND "portal_policy"."maintenance_interval_sec" <= 604800));--> statement-breakpoint
